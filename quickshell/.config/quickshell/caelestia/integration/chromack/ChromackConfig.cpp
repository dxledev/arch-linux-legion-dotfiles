...
{
    const QString override = qEnvironmentVariable("SHELL_CHROMACK_CONFIG_DIR");
    return override.isEmpty() ? QStandardPaths::writableLocation(QStandardPaths::ConfigLocation) + QStringLiteral("/chromack") : override;
}
