...
Item {
    ...
    readonly property int exclusiveZone: !disabled && Config.bar.persistent ? contentWidth : Config.border.thickness
    readonly property bool shouldBeVisible: !fullscreen && !disabled && (Config.bar.persistent || isHovered)
