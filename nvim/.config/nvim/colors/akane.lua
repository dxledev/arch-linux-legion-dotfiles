...
local colors = {
    ...
    mutedv = "#49476A", -- muted african-violet
...
hi("Function", { fg = colors.coral, bold = true })
hi("Statement", { fg = colors.violet })
hi("Conditional", { fg = colors.violet })
hi("Repeat", { fg = colors.violet })
hi("Operator", { fg = colors.cream })
hi("Keyword", { fg = colors.rose, italic = true })
hi("PreProc", { fg = colors.amber })
hi("Type", { fg = colors.violet })
hi("Special", { fg = colors.blush })
hi("Underlined", { fg = colors.cream, underline = true })
hi("Todo", { fg = colors.bg, bg = colors.fg, bold = true })
hi("Constant", { fg = colors.blush })
hi("String", { fg = colors.cream })
hi("Character", { fg = colors.cream })
hi("Number", { fg = colors.amber })
hi("Boolean", { fg = colors.amber })
...
hi("@keyword.type.cpp", { fg = colors.cream, italic = true })
hi("@type", { link = "Type" })
hi("@type.builtin", { link = "Type" })
hi("@type.qualifier", { fg = colors.cream, italic = true })
hi("@type.qualifier.cpp", { fg = colors.cream, italic = true })
...
hi("@punctuation", { fg = colors.ash })
hi("@punctuation.bracket", { fg = colors.ash })
hi("@punctuation.delimiter", { fg = colors.ash })
