...
bind_exec(mainMod, "F", "Toggle Window Floating Status", "hyprctl dispatch togglefloating && hyprctl dispatch resizeactive exact 1200 800 && hyprctl dispatch centerwindow")
bind("bindd", mainMod .. " SHIFT", "F", "Toggle Fullscreen", "fullscreen", "")
bind("bindd", mainMod, "T", "Toggle Window Tiling Status", "settiled", "")
bind_exec(mainMod, "P", "Pin Window", "hyprctl dispatch setfloating && hyprctl dispatch resizeactive exact 725 510 && hyprctl dispatch pin")
