hl.config({
    plugin = {
        hymission = {
            ...
            niri_layout_scale = 1.2,
            niri_multi_ws_scale = 0.40,
            niri_workspace_gap = 25.0,
            niri_window_gaps = -1,
            niri_mode_show_empty_workspaces_btwn = 1,
            niri_mode_wallpaper_zoom = 1,
            niri_mode_wallpaper_zoom_layer_namespaces = "awww-daemon, noctalia-wallpaper, noctalia-desktop-widget-.*, caelestia-background",
            ...
            hide_namespaces_overview = "hypr-dock,waybar,chromack,wardnc,wardbnc,dashboard,rofi,caelestia-drawers",
